    ...
    <main id="top" className="page">
      ...
      <section id="about" className="about">
        ...
        <aside className="profile" aria-label="Career summary">
          <figure className="portrait"><div className="portrait-frame"><img src="/amos-roche-portrait-shirt.png" alt="Amos Roche" width={1224} height={1285} decoding="async" /></div></figure>
