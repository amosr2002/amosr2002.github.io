...
function Sketch({ kind }: { kind: Kind }) {
  if (kind === "tts") return <svg viewBox="0 0 180 54" aria-hidden="true"><path className="thumb-trace" d="M44 27h14m28 0h14m30 0h14" /><rect className="thumb-block block-one" x="10" y="17" width="34" height="20" rx="2" /><rect className="thumb-block block-two" x="58" y="17" width="28" height="20" rx="2" /><rect className="thumb-block block-four" x="100" y="17" width="30" height="20" rx="2" /><rect className="thumb-block block-five" x="144" y="17" width="25" height="20" rx="2" /><text className="thumb-text" x="27" y="30">TXT</text><text className="thumb-text" x="72" y="30">SEM</text><text className="thumb-text" x="115" y="30">CFM</text><text className="thumb-text" x="156" y="30">MEL</text></svg>;
